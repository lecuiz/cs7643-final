...
class DecoderLSTM(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        out, (hidden_state, cell_state) = self.lstm_decoder(lstm_input, (hidden_state, cell_state))
...
class ImageCaptioningModel(nn.Module):
    def __init__(self, vocab_size, embed_dim, hidden_dim, dropout, num_heads):
        ...
        self.decoder = DecoderLSTM(vocab_size, embed_dim, hidden_dim, dropout, num_heads)
